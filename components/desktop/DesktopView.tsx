...
export const DesktopView: React.FC<Props> = ({
    lang, setLang, t, status, isTranscribing, onResetApiKey, isTauri,
    audioRef, audioUrl, mimeType, fileHash, duration, isPlaying, setIsPlaying,
    isRecording, startRecording, stopRecording, processAudioSource,
    report, localAnalysis, preTranscription, handleRunAnalysis, seekTo,
    selection, setSelection, logs
}) => {
    return (
