...
const AnalysisCard: React.FC<Props> = ({ icon, title, data, color }) => {
  const styles = {
    cyan: { border: 'border-cyan-500/20', bg: 'bg-cyan-500/5', icon: 'text-cyan-400', accent: 'bg-cyan-500' },
    amber: { border: 'border-amber-500/20', bg: 'bg-amber-500/5', icon: 'text-amber-400', accent: 'bg-amber-500' },
    slate: { border: 'border-white/10', bg: 'bg-white/5', icon: 'text-slate-400', accent: 'bg-slate-500' },
    red: { border: 'border-rose-500/20', bg: 'bg-rose-500/5', icon: 'text-rose-400', accent: 'bg-rose-500' },
    green: { border: 'border-brand-500/20', bg: 'bg-brand-500/5', icon: 'text-brand-500', accent: 'bg-brand-500' },
    indigo: { border: 'border-indigo-500/20', bg: 'bg-indigo-500/5', icon: 'text-indigo-400', accent: 'bg-indigo-500' },
  };
