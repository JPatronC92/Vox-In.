        ...
        <header className="px-4 py-3 nav-blur border-b border-white/5 flex items-center justify-between z-50 shrink-0">
            <div className="flex items-center gap-3">
                ...
                <div className="overflow-hidden">
                    <h1 className="text-sm font-extrabold tracking-tight text-white leading-none whitespace-nowrap truncate">VOX INTELLIGENCE</h1>
            ...
            <div className="flex items-center gap-2 md:gap-4 shrink-0">
                ...
                <div className="px-2 py-1 rounded-full border border-white/5 bg-white/5 flex items-center gap-2 shrink-0">
                    ...
                    <span className="text-[10px] font-bold text-white uppercase hidden sm:block">{isTranscribing ? (lang === 'es' ? 'PROCESANDO' : 'PROCESSING') : status}</span>
                </div>
