  ...
  return (
    <>
      <div
        ...
        className="flex flex-col items-center justify-center p-6 md:p-8 rounded-2xl border-2 border-dashed border-white/10 bg-white/5 text-slate-400 hover:bg-white/10 active:scale-95 transition-all cursor-pointer"
      >
