              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-base font-bold text-white">
                    {t.speaker} {speaker.id}
                  </p>
                  <p className="text-xs text-slate-500 flex items-center gap-1">
                    {getDetectionIcon(speaker.detectedVia)}{' '}
                    {t[speaker.detectedVia as keyof typeof t] || speaker.detectedVia}
                  </p>
                </div>
              </div>
              <div
                className={`px-2 py-1 rounded-full text-xs font-bold uppercase ${emotionColors[speaker.emotionalState] || emotionColors.neutral}`}
              >
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              ...
              <div className="p-2 bg-white/5 rounded-lg">
                ...
                <div className="flex items-center justify-center gap-1">
                  <p
                    className={`text-base font-bold ${speaker.stressLevel > 70 ? 'text-rose-400' : speaker.stressLevel > 40 ? 'text-amber-400' : 'text-emerald-400'}`}
                  >
                    {speaker.stressLevel}%
                  </p>
                </div>
